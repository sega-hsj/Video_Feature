...
def get_model(args):
    assert args.type in ['2d', '3d', 's3dg', 'obj']
    if args.type == '2d':
        ...
        print('Loading OpenImage Faster-RCNN ...')
        model = faster_rcnn.build_model('videocnn/TSD/configs/OpenImages_configs/r50-FPN-1x_classsampling_TSD/r50-FPN-1x_classsampling_TSD.py', args.rcnn_model_path)
